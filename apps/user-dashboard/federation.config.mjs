...
export default withNativeFederation({
  ...
  exposes: {
    './Component': './apps/user-dashboard/src/app/app.ts',
  },
    ...
    ...shareAll(
      { singleton: true, strictVersion: true, requiredVersion: 'auto', build: 'package' },
      {
        overrides: {
          ...
          '@angular/router': { singleton: true, strictVersion: true, requiredVersion: 'auto', build: 'package', includeSecondaries: { keepAll: true } },
        },
      },
    ),
  },
